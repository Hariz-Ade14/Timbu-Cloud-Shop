...
import {AiOutlineMenu,AiOutlineHeart,AiOutlineSearch,AiOutlineShoppingCart,AiOutlineUser,AiOutlineBars} from 'react-icons/ai'
import "./Header.css";
  ...
  return (
    ...
    <div className="header flex align-middle justify-between px-sm-5 p-2 py-3">
         ...
         <div className='menuList'>
              <ul className=''>
                  <li>Home</li>
                  <li><Link href="/Pages/Home">Products</Link></li>
                  <li>About Us</li>
                  <li>Contact Us</li>
              </ul>
         </div>
         ...
         <div className="menuMob" ref={menuRef}>
              <h2 className='cancel' onClick={Cancel}>X</h2>
              <ul className=''>
                  <li>Home</li>
                  <li><Link href="/Pages/Home">Products</Link></li>
                  <li>About Us</li>
